 ...
 * Thu Sep 03 2020 14:26:42 GMT+0100 (British Summer Time)
...
eventHTMLElem('keyup', ['DOCUMENT'], false, function(event) {
  if (getEventProperty('key', event) == 'ArrowLeft') {
    console.log('go left!');
  } else if (getEventProperty('key', event) == 'ArrowRight') {
...
registerOnHover(['Aset_edible_fruit_S_ujbjdalva_LOD4', 'Aset_food_fruit_S_teypehhra_LOD3', 'Aset_misc__S_ucdmchzhw_LOD5', 'Aset_other__S_uenkeewfa_LOD5'], function() {
...
registerOnClick('avocado', function() {
