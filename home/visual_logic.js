 ...
 * Fri Sep 11 2020 15:26:02 GMT+0100 (British Summer Time)
...
_initGlob.output.initOptions.preloaderProgressCb = function(percentage) {
    ...
    (function() {
  setHTMLElemStyle('width', String(Math.round(_initGlob.percentage)) + '%', 'loader', false);
})();
};
...
registerOnHover('MOTH_CUBE', function() {
  setHTMLElemStyle('cursor', 'pointer', ['BODY'], false);
  outline(['MOTH-WINGS.001', 'MOTH-WINGS.002', 'MOTH-WINGS.003', 'MOTH-WINGS.004', 'MOTH-WINGS.005'], 'ENABLE');
}, function() {
  setHTMLElemStyle('cursor', 'default', ['BODY'], false);
  outline(['MOTH-WINGS.001', 'MOTH-WINGS.002', 'MOTH-WINGS.003', 'MOTH-WINGS.004', 'MOTH-WINGS.005'], 'DISABLE');
});
...
registerOnHover('red_door', function() {
  setHTMLElemStyle('cursor', 'pointer', ['BODY'], false);
  outline('red_door', 'ENABLE');
}, function() {
  setHTMLElemStyle('cursor', 'default', ['BODY'], false);
  outline('red_door', 'DISABLE');
});
registerOnHover('candle.003', function() {
  setHTMLElemStyle('cursor', 'pointer', ['BODY'], false);
  outline('candle.003', 'ENABLE');
}, function() {
  setHTMLElemStyle('cursor', 'default', ['BODY'], false);
  outline('candle.003', 'DISABLE');
});
registerOnHover('Radiator ', function() {
  setHTMLElemStyle('cursor', 'pointer', ['BODY'], false);
  outline('Radiator ', 'ENABLE');
}, function() {
  setHTMLElemStyle('cursor', 'default', ['BODY'], false);
  outline('Radiator ', 'DISABLE');
});

registerOnClick('applecore', function() {
  openWebPage('https://repose.space/roller.html', 'NEW');
}, function() {});
registerOnClick('MOTH_CUBE', function() {
  openWebPage('https://repose.space/window.html', 'NEW');
}, function() {});
...
registerOnClick('red_door', function() {
